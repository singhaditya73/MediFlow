      ...
      <div className="container px-4 py-6 mx-auto relative z-10">
        <main className="py-12">
          <section className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 mb-6 px-4 py-1.5 bg-gradient-to-r from-teal-500/10 to-blue-500/10 dark:from-teal-500/20 dark:to-blue-500/20 rounded-full text-sm font-medium text-teal-600 dark:text-teal-400 border border-teal-500/20 dark:border-teal-400/20">
              <Shield className="w-4 h-4" />
              <span>Secure • Decentralized • Patient-Owned</span>
            </div>
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Mediflow transforms healthcare data management through blockchain technology and FHIR standards, giving you complete ownership of your medical records.
            </p>
